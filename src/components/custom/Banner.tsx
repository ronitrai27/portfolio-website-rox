...
export function AnimatedGradientTextDemo() {
  return (
    <div className="group relative mx-auto flex items-center justify-center rounded-full px-4 py-1.5 shadow-[inset_0_-8px_10px_#8fdfff1f] transition-shadow duration-500 ease-out hover:shadow-[inset_0_-5px_10px_#8fdfff3f] w-fit">
      <span
        className={cn(
          "animate-gradient absolute inset-0 block h-full w-full rounded-[inherit] bg-linear-to-r from-orange-400/70 via-french to-ocean bg-[length:300%_100%] p-[1px]"
        )}
        style={{
          WebkitMask:
      ...
      <AnimatedGradientText className="text-sm font-medium font-inter">
        Founder & Team Lead
